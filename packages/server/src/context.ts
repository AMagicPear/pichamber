...
/** Pull a Model<Api> down to the slim ModelDescriptor the wire already
 *  ships. Avoids the pi-ai Model<TApi> type leaking into shared. */
const modelDescriptor = (session: AgentSession): ModelDescriptor | undefined => {
