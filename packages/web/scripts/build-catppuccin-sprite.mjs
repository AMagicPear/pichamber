...
const sprite = `<!--
  Generated by scripts/build-catppuccin-sprite.mjs from
  catppuccin-vsc-icons (MIT). This file is a derivative work
  (mechanical concatenation of every <icons/mocha/*.svg> into a single
  <symbol> sprite); the upstream copyright notice is preserved here per
  the MIT terms. See THIRD_PARTY_LICENSES.md in the repo root for the
  full attribution list across all bundled dependencies.
