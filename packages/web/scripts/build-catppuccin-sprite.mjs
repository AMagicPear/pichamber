...
const sprite = `<!--
  ...
  catppuccin-vsc-icons (MIT). Upstream copyright:

    Copyright (c) 2023 Catppuccin
    Copyright (c) 2023 thang-nm

  This file is a derivative work (mechanical concatenation of every
  <icons/mocha/*.svg> into a single <symbol> sprite) and is therefore
  subject to the same MIT terms: https://opensource.org/licenses/MIT
-->
