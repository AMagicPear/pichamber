...
.settings-option :deep(input[type="number"]) { height: 30px; min-width: 150px; padding: 0 7px; border: 1px solid var(--ui-border); border-radius: 5px; outline: 0; background: var(--ui-surface); color: var(--ui-text); font: inherit; font-size: 12px; }
.settings-option :deep(input[type="number"]) { width: 130px; }
.settings-option :deep(input:disabled) { cursor: default; opacity: 0.55; }
