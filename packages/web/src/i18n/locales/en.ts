...
export default {
  ...
  sidebar: {
    ...
    forkSessionSuccess: "Forked session into {project}",
    ...
    shortcuts: {
      ...
      dismissOrAbort: "Dismiss suggestions or abort",
      openCommands: "Open commands",
      openFiles: "Open file picker",
  ...
  settings: {
    ...
    extensions: {
      ...
      installedHint: "Manage extensions installed globally for Pi Chamber. Project extensions are not shown here.",
      installHint: "Search and install Pi packages from the official {link} gallery, or add a custom source below.",
      searchPlaceholder: "Filter packages by name, description, or author…",
      searchLabel: "Search the extension catalog",
      searchMarket: "Search",
      marketType: "Type",
      marketSort: "Sort",
      allTypes: "All types",
      sortDownloads: "Most downloads",
      sortRecent: "Recently published",
      sortName: "A-Z",
      resultsCount: "{count} packages",
      ...
      installScopeDesc: "Catalog packages and custom sources use this install location.",
      sourceBadge: {
        piDev: "official",
        npm: "npm",
      },
      addCustomSource: "Add a custom source",
      addCustomSourceDesc: "Paste a git, URL, or local package path.",
      customSourcePlaceholder: "git:https://… or ./path",
      customSourceLabel: "Custom source",
      customSourceHint: "New sources load when the next session starts.",
      type: {
        extension: "extension",
        skill: "skill",
        theme: "theme",
    ...
    skills: {
      ...
      unavailable: "The active runtime cannot enumerate skills.",
      modelOnly: "Explicit invocation only",
      disable: "Disable",
    ...
    providers: {
      ...
      refreshModels: "Refresh this provider's model catalog",
  ...
  composer: {
    ...
    modelRejectsImages: "The selected model does not accept images — switch to an image-capable model",
